 ...
 */
(function(a){Follow.extend({load:function(b,c){b.forEach(function(d){if(d.module){a.ajax({url:c.modules_path+d.module+".js",context:this,dataType:"script",complete:function(){this(d.chain,d.json)}})}else{this(d.chain,d.json)}},this)}});Follow.module=function(b){Follow(b.model,b.storage).follow(b.chain,b.init,"once")}}(window.jQuery));