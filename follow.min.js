 ...
 * Dependencies: jQuery
 */
this.jQuery&&(function(b){var a={links:[],getModelByElemAttrs:function(d){var e=d.data("follow-model")||"";var c=d.data("follow-storage")||"undefined";return Function('return Follow("'+e+'", '+c+")")()}};Follow.link=function(c){a.links.push(c);return a.links};b(document).delegate("input[data-follow], select[data-follow], textarea[data-follow]","change",function(){var e=b(this),d=e.data("follow"),c=a.getModelByElemAttrs(e);c(d,e.is(":checkbox")?e.prop("checked"):e.val())});Follow.sync=function(f){var c=this,d=f.chain,e=f.value;b('[data-follow="'+d+'"]').each(function(){var h=b(this),j=false,g=a.getModelByElemAttrs(h)===c,i=function(){if(g){if(h.is(":checkbox")||h.is(":radio")){(h.is(":checkbox")||(h.is(":radio")&&h.val()==e))&&h.attr("checked",!!e)}else{if(h.is("input")||h.is("select")||h.is("textarea")){h.is("select[multiple]")&&c.gettype(e)!="array"&&(e=c.map(e,function(k){return k}));h.val(e)}else{if(h.is("img")){h.attr("src",e)}else{h.html(e)}}}}};b.each(a.links,function(){if(g&&h.is(this.match)){j=true;return this.trigger(h,{value:e,chain:d,applyDefault:i})}});!j&&i()})};Follow.extend({getElementsByChain:function(d){var c=this;return b('[data-follow="'+d+'"]').filter(function(){var e=b(this);return a.getModelByElemAttrs(e)===c})},getChainByElement:function(c){return c.data("follow")},importDataFromDOM:function(){var c=this,d={};b("[data-follow]").each(function(){var f=b(this),e=f.data("follow"),h=a.getModelByElemAttrs(f);if(c===h&&!d[e]){var g;if(f.is(":checkbox")){g=f.prop("checked")}else{if(f.is(":radio")&&f.attr("name")){g=b(':radio[name = "'+f.attr("name")+'"]').val()}else{if(f.is("input")||f.is("select")||f.is("textarea")){g=f.val()}else{g=f.text()}}}d[e]=true;c(e,g)}})},exportDataToDOM:function(e){var d=this,e=e||"",c=e?this(e):this(),f=this.constructor.sync;e&&f.call(d,{chain:e,value:c});this.extend(true,{},c,function(h,g){f.call(d,{chain:(e?e+".":"")+h,value:g})})}})}(this.jQuery));
/*!
