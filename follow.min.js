 ...
 */
Follow.utils.json_to_xml=function(d,c){if(typeof d=="string"){try{d=JSON.parse(d)}catch(g){d=Function("return "+d)()}}var a=this,b={str:['<model type="'+this.type(d)+'">',"","\n</model>"],doc:null},f={level:/\./g,quote:/"/g};var h=1;this.extend(true,{},d,function(l,o,k){var j=a.type(o),m=(l.match(f.level)||[]).length+2,i="\n"+Array(m).join("\t"),e=["array","object"].indexOf(j)!==-1,o=!e?' value="'+String(o).replace(f.quote,'\\"')+'"/':"",n={opentag:'<p name="'+k+'" type="'+j+'" path="'+l+'"'+o+">",closetag:"</p>"};if(h>m){b.str[1]+=i+n.closetag}b.str[1]+=i+n.opentag;h=m});b.str=b.str.join("");return(c?b.str:this.parse_xml(b.str))};Follow.utils.parse_xml=function(f){if(typeof DOMParser!="undefined"){return(new DOMParser()).parseFromString(f,"text/xml")}else{if(document.implementation||typeof ActiveXObject!="undefined"){var d;try{d=document.implementation.createDocument()}catch(c){d=new ActiveXObject("MSXML2.DOMDocument")}d.loadXML(f);return d}else{var a="data:text/xml;charset=utf8,"+encodeURIComponent(f);var b=new XMLHttpRequest();b.open("GET",a,false);b.send(null);return b.responseXML}}};
/*!
 * Follow.js
