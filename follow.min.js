 ...
 * Core of the library.
 */
(function(){var e={};function b(f,j,g){var j=j||e,f=f||"default",h=j[f];g&&(j[f]="");var i=function(k,t,o){var u=i,q=d(arguments),p=JSON.parse(u.toJSON()),k=k instanceof Array?k.join("."):k,v=typeof k=="object"?{}:String(k).split("."),l,s=p;function r(){while(l=v.shift()){if(l&&s[l]!==undefined){s=s[l]}else{return null}}return s}function m(){while(l=v.shift()){if(v.length==0){var x=s[l],y={chain:k,prop:l,parent:s,model:p},w=typeof t=="function"?t.apply(u,[typeof x!="object"?x:u.clone(x),c({value:x},y)]):t;if(u.toJSON(k)!==a(w)){if(!o||x===undefined){(w===undefined&&s instanceof Array)?s.splice(l,1):(s[l]=w);j[f]=a(p);u.tracking(k);u.broadcast(k,[w,c({value:{prev:x,current:w}},y)])}}}else{!s[l]&&(s[l]={});s=s[l]}}}u.__hook&&u.__hook.apply(u,q);if(typeof k=="object"){for(var n in k){k.hasOwnProperty(n)&&u(n,k[n],q[1])}}else{if(q.length==1){return u.__get(r(),q)}else{if(q.length>=2){m();return u}}}return p};c(i,{constructor:b,modelName:f,storage:j,followers:{},dependency:{composite:{},on:{}},backups:[],wrappers:[],__hook:null,__get:function(k){return k},extend:c,clone:function(k){return JSON.parse(JSON.stringify(k))},init:function(k){this(h?JSON.parse(h):k||{})},toString:function(k){return k?a(this(k)):j[f]||"{}"}},b.prototype);return i}function a(f){return JSON.stringify(f,null,"\t")}function d(f){return[].slice.call(f)}function c(f,k){var g=d(arguments),j=f===true&&g.shift(),k=g.shift(),i=function(){return g[g.length-1]},l,h;typeof i()=="string"&&(h=g.pop());typeof i()=="function"&&(l=g.pop());g.forEach(function(p){for(var m in p){if(p.hasOwnProperty(m)){var o=null,r=p[m];j&&typeof r=="object"&&r!==null&&(o=r.constructor==Array?[]:r.constructor==Object?{}:"");var n,q=[true,o,k[m],r];l&&(n=h?h+"."+m:String(m),l(n),q.push(l,n));k[m]=o?c.apply(this,q):r}}});return k}b.extend=function(){c.apply(null,[true].concat(this.prototype,d(arguments)))};window.Follow=b}());
/*!
 * Follow.js
 * A main part of the library.
 */
Follow.extend({follow:function(b,d,c){var a=b instanceof RegExp;String(b).trim().split(/\s+/).forEach(function(e){var f=this.wrap.apply(this,[a?b:e,d,c]);!this.followers[e]&&(this.followers[e]=[]);this.followers[e].push(f)},this);return this},unfollow:function(a,b){String(a).trim().split(/\s+/).forEach(function(d){var c=this.followers[d];if(c){if(b){this.followers[d]=c.filter(function(e){return e.callback!=b})}if(!this.followers[d].length||!b){delete this.followers[d]}}},this);return this},toJSON:function(){return this.toString.apply(this,arguments)},clear:function(e,c){if(c){if(e){var a,d=this.dependency;delete this.followers[e];delete d.composite[e];for(var b in d.on){d.on.hasOwnProperty(b)&&(d.on[b]=d.on[b].filter(function(f){return !(f.chain==b||f.chain==e)}))}}else{this.followers={};this.dependency={composite:{},on:{}}}}if(e){this(e,undefined)}else{delete this.storage[this.modelName]}return this},backup:function(a){var b={model:this.toJSON(),followers:this.extend(true,{},this.followers),dependency:this.extend(true,{},this.dependency)};a&&(this.backups[a]=b);this.backups.push(b);return this},restore:function(a){var a=a==null?-1:a,b=typeof a=="string"?this.backups[a]:this.backups.slice(a)[0];b&&(this.storage[this.modelName]=b.model,this.followers=b.followers,this.dependency=b.dependency);return this},composite:function(d,f,a){var e=this.dependency,c=e.composite[d];if(typeof f=="function"){this.__hook=function(g){e.on[g]=e.on[g]||[];!e.on[g].some(function(h){return h.chain===d})&&e.on[g].push({chain:d,sensible:a})};this(d,function(h,i){var g=this,h=f.call(this,i);delete this.__hook;e.composite[d]=function(){return f.call(g,i)};return h});return this}else{if(f===false){for(var b in e.on){if(e.on.hasOwnProperty(b)){e.on[b]=e.on[b].filter(function(g){return g.chain!==d})}}delete e.composite[d]}}return c},tracking:function(a){for(var b in this.dependency.on){this.dependency.on.hasOwnProperty(b)&&this.dependency.on[b].forEach(function(e){var d=[a===b,a.indexOf(b+".")===0],c=e.sensible?d.some(function(g){return g}):d.shift();if(c){var f=this.dependency.composite[e.chain]();f===undefined&&(f=null);this(e.chain,f)}},this)}},dispatch:function(a,c,b){this(a,function(f){var e={number:typeof b=="number",func:typeof b=="function"},d=[].slice.call(arguments),g=this.extend(true,d,c);this.broadcast(a,g,function(i,h){if(b!=null){if(e.number&&b==h){return true}if(e.func&&b==i.callback){return true}}else{return true}});return f});return this},broadcast:function(a,d,b){var c=this.followers,f=d[1]||{};for(var e in c){c.hasOwnProperty(e)&&c[e].filter(b||function(){return true}).forEach(function(h){var g=h.path;(g==a||(g instanceof RegExp&&(f.match=a.match(g))))&&(h.callback.apply(this,d),delete f.match)},this)}},wrap:function(b,e,c){var a=function(g,f){return function(i){var h=i,i=i.replace(/[\[\]\(\)\.\*\+\\\{\}\^\$]/g,"\\$&");return{path:g.call(this,i),callback:function(){f?e.apply(this,arguments):this(h,function(j,k){e.apply(this,arguments);return j})}}}},d=this.extend({},this.wrappers,{once:function(g,h){var f=function(){h.apply(this,arguments);this.unfollow(g,f)};return{path:g,callback:f}},sensible:a(function(f){return RegExp("^("+f+"|"+f+"\\..*)$")}),children:a(function(f){return RegExp("^"+f+".([^.]+)$")},true)});return d[c]?d[c].apply(this,arguments):{path:b,callback:e}},merge:function(a){var b=this.constructor("merge"),c=[];b(a);this.extend(true,{},a,function(d){c.push(d)});c.forEach(function(d){var e=b(d);typeof e!="object"&&this(d,e)},this);b.clear();return this}});
/*!
 * Follow.js
