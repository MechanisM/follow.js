 ...
 * Core of the library.
 */
(function(b){var h={},d={};function c(j,n,k){var n=n||h,j=j||"default",l=n[j],i=d[j];k&&(n[j]="");if(i&&n==i.storage){return i.model}var m=function(o,x,t){var y=m,u=g(arguments),s=JSON.parse(y.toJSON()),o=o instanceof Array?o.join("."):o,z=typeof o=="object"?{}:String(o).split("."),p,w=s,t={if_not_defined:t=="safe",is_forced:t=="force"};function v(){while(p=z.shift()){if(p&&w[p]!==undefined){w=w[p]}else{return null}}return w}function q(){while(p=z.shift()){if(z.length==0){var C=w[p],E=C===undefined,D={chain:o,prop:p,parent:w},A=typeof x=="function"?x.apply(y,[typeof C!="object"?C:y.clone(C),e({value:C},D)]):x,B=A===undefined;(!t.if_not_defined||E)&&((B&&!E)||!B)&&((y.toJSON(o)!==a(A))||(A===null&&E)||(t.is_forced))&&function(){(A===undefined&&w instanceof Array)?w.splice(p,1):(w[p]=A);n[j]=a(s);y.tracking(o);y.broadcast(o,[A,e({value:{prev:C,current:A}},D)])}()}else{!w[p]&&(w[p]={});w=w[p]}}}y.__hook&&y.__hook.apply(y,u);if(typeof o=="object"){for(var r in o){o.hasOwnProperty(r)&&y(r,o[r],u[1])}return y}else{if(u.length==1){return y.__get(v(),u)}else{if(u.length>=2){q();return y}}}return s};e(m,{constructor:c,modelName:j,storage:n,followers:{},dependency:{composite:{},on:{}},backups:[],wrappers:[],__hook:null,__get:function(o){return o},extend:e,serialize:a,clone:f,init:function(o){this(l?JSON.parse(l):o||{});return this},toString:function(o){return o?a(this(o)):n[j]||"{}"}},c.prototype);d[j]={model:m,storage:n};return m}function a(i){return JSON.stringify(i,null,"\t")}function g(i){return[].slice.call(i)}function f(i){return JSON.parse(JSON.stringify(i))}function e(i,n){var j=g(arguments),m=i===true&&j.shift(),n=j.shift(),l=function(){return j[j.length-1]},o,k;typeof l()=="string"&&(k=j.pop());typeof l()=="function"&&(o=j.pop());j.forEach(function(u){for(var p in u){if(u.hasOwnProperty(p)){var t=n[p],r=u[p],v=r==null||String(typeof r).match(/string|number|boolean/),q=[true,n[p],r];if(o){var s=k?k+"."+p:String(p);o(s);q.push(o,s)}t==null||v||!m?(n[p]=r):e.apply(this,q)}}});return n}c.extend=function(){e.apply(null,[true].concat(this.prototype,g(arguments)))};b.Follow=c}(this));
/*!
 * Follow.js
